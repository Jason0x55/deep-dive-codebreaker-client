...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    while (true){
      ...
      try {
        Response<Guess> guessResponse = gameService.createGuess(game.getId(), guess).execute();
        Guess guessFromServer = guessResponse.body();
        //Guess guessFromServer = gameService.createGuess(game.getId(), guess).execute().body();
